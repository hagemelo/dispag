echo off
echo "Inicializar Microsservico NovoOrcamento"

##Kafka Config
set KAFKA_SERVER=172.24.158.86:9092
set KAFKA_GROUP=DISPAG
set KAFKATOPIC=NOVOORCAMENTO
...
call java -jar -Xms768M -Xmx768M -Xmn256m -XX:MaxMetaspaceSize=64m -XX:+UseG1GC  target/novoorcamento-1.0.0.jar
cd ..
