...
@SpringBootTest()
@ActiveProfiles("test")
@ContextConfiguration(classes={DebitosRepository.class, ExcluirDebitoKafkaConsumerTest.class})
@DirtiesContext
@EmbeddedKafka(partitions = 1, brokerProperties = { "listeners=PLAINTEXT://localhost:9092", "port=9092" })
public class EcluirDebitoConsumerServiceTest {

	@Autowired
	private EcluirDebitoConsumerServiceTest service;
